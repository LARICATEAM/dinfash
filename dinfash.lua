...
local UserName = (data.username_ or "qwrrcc25")
local NameUser = "[- dinfash 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/qwrrcc25)\n — — — — — — — — —\n⌔︙بواسطه -› ["..data.first_name_.."](T.me/"..UserName..")"
local NameUserr = "[- dinfash 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/qwrrcc25)\n — — — — — — — — —\n⌔︙اسم المستخدم -› ["..data.first_name_.."](T.me/"..UserName..")"
if status == "lock" then
...
send(msg.chat_id_, msg.id_,"[- dinfash 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/qwrrcc25)\n — — — — — — — — —\n⌔︙العضو -› ["..data.first_name_.."](t.me/"..(data.username_ or "qwrrcc25")..")".."\n⌔︙تم رفعه "..RTPA.." هنا\n")
...
if dinfashrt == "مميز" and Addictive(msg) then
send(msg.chat_id_, msg.id_,"[- dinfash 𝖲𝗈𝗎𝗋𝖼𝖾 .](https://t.me/qwrrcc25)\n — — — — — — — — —\n⌔︙العضو -› ["..result.title_.."](t.me/"..(text1[3] or "qwrrcc25")..")".."\n⌔︙تم رفعه "..text1[2].." هنا")   
database:sadd(bot_id.."dinfash:Special:User"..msg.chat_id_,result.id_)  
...
local UserName = (b.username_ or "qwrrcc25")
...
keyboard = {} 
keyboard.inline_keyboard = {
{{text = '- dinfash TeAM .',url="t.me/qwrrcc25"}},
}
local msg_id = msg.id_/2097152/0.5
...
[⌔︙ dinfash 𝖲𝗈𝗎𝗋𝖼𝖾  .](http://t.me/qwrrcc25)
...
inline = {
{{text = '⌔︙ dinfash 𝖲𝗈𝗎𝗋𝖼𝖾  .',url='http://t.me/qwrrcc25'}},
}
...
inline = {
{{text = '⌔︙ dinfash 𝖲𝗈𝗎𝗋𝖼??  .',url='http://t.me/qwrrcc25'}},
}
https.request("https://api.telegram.org/bot"..token.."/deleteMessage?chat_id="..Chat_id.."&message_id="..msg_idd)
send_inlin_key(Chat_id,Text,inline)
